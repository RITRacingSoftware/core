...
#define CORE_ADC_ALLOWED_ADC3       0x0000
#define CORE_ADC_ALLOWED_ADC4       0x0000
#define CORE_ADC_ALLOWED_ADC5       0x0000
#define CORE_ADC_ALLOWED_OPAMP1     0x0100
#define CORE_ADC_ALLOWED_OPAMP2     0x0200
#define CORE_ADC_ALLOWED_OPAMP3     0x0400
#define CORE_ADC_ALLOWED_OPAMP4     0x0000
#define CORE_ADC_ALLOWED_OPAMP5     0x0000
#define CORE_ADC_ALLOWED_OPAMP6     0x0000
