...
.word	_ebss
/* start address for the uninitialized .noinit section. 
...
.size	Reset_Handler, .-Reset_Handler
    ...
    .section	.text.boot_soft_toggle
    .type       boot_soft_toggle, %function
    .global boot_soft_toggle
boot_soft_toggle:
    ldr r1, =0x40010000     /* r1 = &(SYSCFG->MEMRMP) */
    ldr r0, [r1, #0]        /* r0 = *r1; */
