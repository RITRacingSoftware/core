...
/*** BOOTLOADER CONFIG ***/
#define CORE_BOOT_PORT GPIOA
#define CORE_BOOT_PIN GPIO_PIN_15
#define CORE_BOOT_AF 7
#define CORE_BOOT_USART_BAUD 500000
#define CORE_BOOT_USART_TIMEOUT 100
#define CORE_BOOT_ADDRESS 0x04
#define CORE_BOOT_NRECV 10
#define CORE_BOOT_FDCAN FDCAN1
#define CORE_BOOT_FDCAN_ID 4
#define CORE_BOOT_FDCAN_MASTER_ID 100
